...
case Rails.env
  ...
  when 'development', 'production', 'staging'
    ...
    baires_r = Region.create!(name: 'buenos_aires', country: arg)
    patagonia_arg = Region.create!(name: 'patagonia_argentina', country: arg)
    nor_este_arg = Region.create!(name: 'nor_este_argentino', country: arg)
    cuyo = Region.create!(name: 'cuyo', country: arg)
    cordoba_r = Region.create!(name: 'cordoba', country: arg)
    cruceros_r_arg = Region.create!(name: 'cruceros', country: arg)
    nor_oeste_arg = Region.create!(name: 'nor_oeste_arg', country: arg)

    norte_chileno = Region.create!(name: 'norte_chileno', country: chile)
    patagonia_ch = Region.create!(name: 'patagonia_chilena', country: chile)
    santiago_r = Region.create!(name: 'santiago_de_chile', country: chile)
    cruceros_r_ch = Region.create!(name: 'cruceros', country: chile)
